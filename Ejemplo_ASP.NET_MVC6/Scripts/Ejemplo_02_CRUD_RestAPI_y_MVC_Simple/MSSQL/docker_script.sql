...
DROP DATABASE IF EXISTS Ejemplo_02_CRUD_RestAPI_y_MVC_Simple_DB

GO

CREATE DATABASE  Ejemplo_02_CRUD_RestAPI_y_MVC_Simple_DB

GO

USE Ejemplo_02_CRUD_RestAPI_y_MVC_Simple_DB
